 ...
 */
class getTreatmentRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\TreatmentRepository' shared autowired service.
     *
     * @return \App\Repository\TreatmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TreatmentRepository.php';

        return $container->privates['App\\Repository\\TreatmentRepository'] = new \App\Repository\TreatmentRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
