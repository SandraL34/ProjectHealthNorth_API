...
class getSecurity_Authentication_FailureHandler_Login_JsonLoginService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authentication.failure_handler.login.json_login'] = new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler(new \App\Security\LoginFailureHandler(), []);
    }
}
