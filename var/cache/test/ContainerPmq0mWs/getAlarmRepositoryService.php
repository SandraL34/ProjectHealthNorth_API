 ...
 */
class getAlarmRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\AlarmRepository' shared autowired service.
     *
     * @return \App\Repository\AlarmRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AlarmRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['App\\Repository\\AlarmRepository'])) {
            return $container->privates['App\\Repository\\AlarmRepository'];
        }

        return $container->privates['App\\Repository\\AlarmRepository'] = new \App\Repository\AlarmRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
