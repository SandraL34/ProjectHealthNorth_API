 ...
 */
class getPrescriptionRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrescriptionRepository.php';

        return $container->privates['App\\Repository\\PrescriptionRepository'] = new \App\Repository\PrescriptionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
