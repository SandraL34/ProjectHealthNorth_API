 ...
 */
class getSecurity_Listener_LoginThrottling_LoginService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.listener.login_throttling.login' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.login_throttling.login'] = new \Symfony\Component\Security\Http\EventListener\LoginThrottlingListener(($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), new \Symfony\Component\Security\Http\RateLimiter\DefaultLoginRateLimiter(new \Symfony\Component\RateLimiter\RateLimiterFactory(['policy' => 'fixed_window', 'limit' => 15, 'interval' => '1 minute', 'id' => '_login_global_login'], new \Symfony\Component\RateLimiter\Storage\CacheStorage($a), NULL), new \Symfony\Component\RateLimiter\RateLimiterFactory(['policy' => 'fixed_window', 'limit' => 3, 'interval' => '1 minute', 'id' => '_login_local_login'], new \Symfony\Component\RateLimiter\Storage\CacheStorage($a), NULL)));
    }
}
