...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AppointmentSlotController' => 'getAppointmentSlotControllerService',
            'App\\Controller\\CenterController' => 'getCenterControllerService',
            'App\\Controller\\DoctorController' => 'getDoctorControllerService',
            'App\\Controller\\HealthNorthController' => 'getHealthNorthControllerService',
            ...
            'App\\Controller\\TreatmentController' => 'getTreatmentControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('Lexik\\Bundle\\JWTAuthenticationBundle\\Event\\JWTCreatedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\JwtCreatedSubscriber'] ?? ($this->privates['App\\EventSubscriber\\JwtCreatedSubscriber'] = new \App\EventSubscriber\JwtCreatedSubscriber()));
        }, 1 => 'onJWTCreated'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rpV3nTiUlk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
