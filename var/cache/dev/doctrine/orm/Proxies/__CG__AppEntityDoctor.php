...
class Doctor extends \App\Entity\Doctor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'firstname', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'lastname', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'specialty', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'phoneNumber', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Doctor' . "\0" . 'patients'];
        }
